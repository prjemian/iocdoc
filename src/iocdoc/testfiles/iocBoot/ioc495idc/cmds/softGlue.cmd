...
#initIP_EP200_FPGA(0, 3, "$(SOFTGLUE)/softGlueApp/Db/SoftGlue_2_2.hex")
#    standard softGlue 2.2 plus two shift registers
#initIP_EP200_FPGA(0, 3, "$(SOFTGLUE)/softGlueApp/Db/SoftGlue_2_2_Octupole_0_0.hex")
#    standard softGlue 2.2 plus two up/down counters
initIP_EP200_FPGA(0, 3, "$(SOFTGLUE)/softGlueApp/Db/SoftGlue_2_2_1ID_Vgate_0_1.hex")
...
initIP_EP200(0, 3, "SGIO_1", "SGIO_2", "SGIO_3", 0x800000)
...
initIP_EP200_Int(0, 3, 0x90, 0x0, 0x0, 0x0, 0x0)
...
#initIP_EP200_IO(0, 3, 201, 0x3c)
initIP_EP200_IO(0, 3, 201, 0xc)
#initIP_EP200_IO(0, 3, 202, 0x13)
...
#!initIP_EP201("SGIO_1",0,3,1000000,0x101,0x800000,0x90,0x00,0x00)
#!initIP_EP201("SGIO_2",0,3,1000000,0x101,0x800010,0x91,0x00,0x00)
#!initIP_EP201("SGIO_3",0,3,1000000,0x101,0x800020,0x92,0x00,0x00)
...
#
# For example:
# initIP_EP201SingleRegisterPort("SOFTGLUE", 0, 3)
initIP_EP201SingleRegisterPort("SOFTGLUE", 0, 3)
...
dbLoadRecords("$(SOFTGLUE)/db/softGlue_SignalShow.db","P=495idc:,H=softGlue:,PORT=SOFTGLUE,READEVENT=10")
...
dbLoadRecords("$(SOFTGLUE)/db/softGlue_FPGAContent.db", "P=495idc:,H=softGlue:,PORT=SOFTGLUE,READEVENT=10")

# This database contains the additional records needed for
# SoftGlue_2_2_Octupole_0_0.hex
#!dbLoadRecords("$(SOFTGLUE)/db/softGlue_FPGAContent_octupole.db", "P=495idc:,H=softGlue:,PORT=SOFTGLUE,READEVENT=10")

# This database contains the additional records needed for
# SoftGlue_2_2_1ID_Vgate_0_1.hex
dbLoadRecords("$(SOFTGLUE)/db/softGlue_FPGAContent_s1ID_Vgate.db", "P=495idc:,H=softGlue:,PORT=SOFTGLUE,READEVENT=10")

#    Interrupt support.
#    ('putenv' is used to fit the command into the vxWorks command line space.)
putenv "SFDB=$(SOFTGLUE)/db/softGlue_FPGAInt.db"
dbLoadRecords("$(SFDB)","P=495idc:,H=softGlue:,PORT1=SGIO_1,PORT2=SGIO_2,PORT3=SGIO_3,FIFO=10")

taskDelay(50)

#    Some stuff just for convenience: software clock and pulse generators, and
#    a couple of busy records.
dbLoadRecords("$(SOFTGLUE)/db/softGlue_convenience.db", "P=495idc:,H=softGlue:")

# Menu of softGlue circuits
# configMenu example.  See create_manual_set() command after iocInit.
dbLoadRecords("$(AUTOSAVE)/asApp/Db/configMenu.db","P=495idc:,CONFIG=SG")
