...
save_restoreSet_status_prefix("12idc:")
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=12idc:, DEAD_SECONDS=5")
...
set_savefile_path("/xorApps/epics/synApps_5_4_2/ioc/12id/iocBoot/ioc12idc", "autosave")
...
set_requestfile_path(top, "12idcApp/Db")
