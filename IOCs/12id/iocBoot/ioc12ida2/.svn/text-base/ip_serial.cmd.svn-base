...
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts01,PORT=TS01,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts02,PORT=TS02,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts03,PORT=TS03,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts04,PORT=TS04,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts05,PORT=TS05,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts06,PORT=TS06,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts07,PORT=TS07,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts08,PORT=TS08,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts09,PORT=TS09,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts10,PORT=TS10,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts11,PORT=TS11,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts12,PORT=TS12,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts13,PORT=TS13,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts14,PORT=TS14,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts15,PORT=TS15,ADDR=0,OMAX=256,IMAX=256")
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=12ida2:,R=ts16,PORT=TS16,ADDR=0,OMAX=256,IMAX=256")
...
#devices support
#Digitel MPC 
#dbLoadRecords("$(VAC)/db/digitelPump.db","P=12ida2:,PUMP=IP1,PORT=TSXX,ADDR=5,DEV=MPC,STN=1")
#dbLoadRecords("$(VAC)/db/digitelPump.db","P=12ida2:,PUMP=IP2,PORT=TSXX,ADDR=5,DEV=MPC,STN=2")
