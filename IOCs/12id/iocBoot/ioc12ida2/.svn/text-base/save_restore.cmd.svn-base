...
save_restoreSet_status_prefix("12ida2:")
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=12ida2:, DEAD_SECONDS=5")
...
set_savefile_path("/xorApps/epics/synApps_5_4_2/ioc/12id/iocBoot/ioc12ida2", "autosave")
...
set_requestfile_path(top, "12ida2App/Db")
