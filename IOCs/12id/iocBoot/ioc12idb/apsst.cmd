...
### Slits
#dbLoadRecords("$(OPTICS)/opticsApp/Db/2slit.db","P=12idb:,SLIT=Slit1V,mXp=m5,mXn=m6")
#dbLoadRecords("$(OPTICS)/opticsApp/Db/2slit.db","P=12idb:,SLIT=Slit1H,mXp=m7,mXn=m8")
