...
str = malloc(300)
strcpy str, "P=12ida1:,Q=HMTable,T=HMtable,M0X=m21,M0Y=m19,M1Y=m18,M2X=m20,M2Y=m17,M2Z=dummy,GEOM=NEWPORT"
dbLoadRecords("$(DIR)/table.db",str)
strcpy str,"P=12ida1:,Q=VMTable,T=VMtable,M0X=dummy,M0Y=m26,M1Y=m24,M2X=dummy,M2Y=m25,M2Z=dummy,GEOM=NEWPORT"
dbLoadRecords("$(DIR)/table.db",str)
