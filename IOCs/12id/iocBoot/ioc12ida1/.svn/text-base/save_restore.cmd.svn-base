...
save_restoreSet_status_prefix("12ida1:")
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=12ida1:, DEAD_SECONDS=5")
...
set_savefile_path("/xorApps/epics/synApps_5_4_2/ioc/12id/iocBoot/ioc12ida1", "autosave")
...
set_requestfile_path(top, "12ida1App/Db")
